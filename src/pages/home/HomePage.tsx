    ...
    <Column gap={4}>
      ...
      <Container>
        <Typography variant="body1">
          ...
          have a deep understanding of operational processes, design principles, and customer
          engagement. My skill set includes branding, front-end development, styling, user
          experience design, and responsive web design. This diverse expertise enables me to create
          cohesive and engaging digital experiences across various platforms, spanning multiple
          departments. With strong interpersonal communication skills, I excel in client-facing
          interactions and leading teams by example. I am deeply passionate about delivering
